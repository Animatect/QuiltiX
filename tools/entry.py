...
# Check for Arnold delegate - search in local delegates folder first, then prebuilt install
PREBUILT_INSTALL = r"C:\Users\ecovo\Documents\GitHub\QuiltX\QuiltiX_win_v0.8.0"
arnold_search_paths = [
    os.path.join(root, "delegates", "Arnold"),
    os.path.join(PREBUILT_INSTALL, "delegates", "Arnold"),
]
for arnold_base in arnold_search_paths:
    # Find any Arnold-*-windows SDK folder
